                            ...
                            <div class="col">
                                <div class="p-5">
                                    <div class="text-center">
                                        <form action="<?php echo base_url('/ba/save_form_pemeriksaan'); ?>" method="POST" enctype="multipart/form-data">
                                            <?= csrf_field(); ?>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col">
                                                    <input type="text" class="form-control" id="no_pemeriksaan" name="no_pemeriksaan" placeholder="Masukkan Nomor BA Pemeriksaan..." value="" required>
